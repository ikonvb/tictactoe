...
import com.konstantinbulygin.tictactoexml.service.GameResultService;
...
import com.konstantinbulygin.tictactoexml.service.StepService;
...
public class RestApiGameController extends GameParser {
    ...
    public ResponseEntity<String> playGame(@RequestBody GameStep gameStep) {
